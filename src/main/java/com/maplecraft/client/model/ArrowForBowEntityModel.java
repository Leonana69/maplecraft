...
public class ArrowForBowEntityModel<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition arrow = partdefinition.addOrReplaceChild("arrow", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -2.5F, 0.0F, 16.0F, 5.0F, 0.0F, new CubeDeformation(0.0F))
				.texOffs(0, 0).addBox(0.0F, -2.5F, -2.5F, 0.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 12.0F, 0.0F, 0.0F, 0.0F, -1.5708F));

		PartDefinition arrow_r1 = arrow.addOrReplaceChild("arrow_r1", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -9.5F, -2.5F, 16.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)),

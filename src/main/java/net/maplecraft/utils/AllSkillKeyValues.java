...
public enum AllSkillKeyValues {
    ...
    MAGIC_CLAW(2001005, 90, 2, 3, 3, 9),

    FIRE_ARROW(2101004, 160, 1, 2, 4, 10),
    POISON_BRACE(2101005, 100, 1, 2, 4, 10),

    COLD_BEAM(2201004, 150, 1, 2, 3, 9),
    THUNDERBOLT(2201005, 100, 1, 3, 9, 0),

    HEAL(2301002, 80, 1, 3, 9, 0),
    HOLY_ARROW(2301005, 140, 1, 2, 4, 10),

    ARROW_BLOW(3001004, 160, 1, 2, 4, 12),
    DOUBLE_SHOT(3001005, 100, 2, 2, 4, 12),

    SOUL_ARROW(3101004, 0, 0, 3, 0, 0),
    ARROW_BOMB(3101005, 120, 1, 3, 4, 12),

    IRON_ARROW(3201005, 160, 1, 3, 4, 12),

    STRAFE(3111006, 80, 4, 4, 4, 12),
    ARROW_RAIN(3111004, 150, 1, 4, 9, 0),

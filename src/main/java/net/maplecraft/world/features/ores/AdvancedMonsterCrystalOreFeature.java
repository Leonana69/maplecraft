package net.maplecraft.world.features.ores;
...
public class AdvancedMonsterCrystalOreFeature extends OreFeature {
    public static AdvancedMonsterCrystalOreFeature FEATURE = null;
    ...
    public AdvancedMonsterCrystalOreFeature() {
